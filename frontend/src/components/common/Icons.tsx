...
export const PaletteIcon = ({ size = 20, ...props }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.92 0 1.7-.63 1.94-1.52.28-1.03.11-1.89-.52-2.58-.63-.7-1.02-1.66-.92-2.73.17-1.86 1.83-3.17 3.7-3.17h2.3c2.49 0 4.5-2.01 4.5-4.5C22 5.37 17.43 2 12 2Z"></path>
  </svg>
);
...
export const ListTodoIcon = ({ size = 20, ...props }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <rect x="3" y="5" width="6" height="6" rx="1"></rect>
    <path d="m3 17 2 2 4-4"></path>
    <path d="M13 6h8M13 12h8M13 18h8"></path>
  </svg>
);
...
export const EyeOffIcon = ({ size = 18, ...props }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
